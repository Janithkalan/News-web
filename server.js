...
db.serialize(async () => {
  ...
  if (articleCount.cnt === 0) {
    await dbRun(`INSERT INTO articles (title, category, content, image, author, is_featured) VALUES (?, ?, ?, ?, ?, ?)`,
      ['Government Announces New Budget for 2026', 'Politics', 'The government has announced a new national budget for 2026, focusing on infrastructure development, education, and healthcare. Finance Minister stated that this budget aims to boost economic growth by 7% over the next fiscal year. Key allocations include roads, hospitals, and digital infrastructure. Citizens have responded positively with expectations of improved public services.', 'budget.png', 'Staff Reporter', 1]);
    await dbRun(`INSERT INTO articles (title, category, content, image, author, is_featured) VALUES (?, ?, ?, ?, ?, ?)`,
      ['National Cricket Team Wins Asia Cup', 'Sports', 'In a thrilling final match, the national cricket team defeated their rivals by 45 runs to clinch the Asia Cup title. Captain led the team brilliantly with a century score. Thousands of fans celebrated on the streets as the team returned home with the trophy. It marks the third consecutive Asia Cup win for the team.', 'cricket.png', 'Sports Desk', 1]);
    await dbRun(`INSERT INTO articles (title, category, content, image, author, is_featured) VALUES (?, ?, ?, ?, ?, ?)`,
      ['New AI Technology Transforms Healthcare', 'Technology', 'Scientists have developed a new artificial intelligence system capable of detecting diseases from medical scans with 98% accuracy. The technology is expected to be rolled out in major hospitals within the next year, significantly reducing diagnosis time from days to minutes. This breakthrough could save thousands of lives annually.', 'ai_health.png', 'Tech Reporter', 0]);
    await dbRun(`INSERT INTO articles (title, category, content, image, author, is_featured) VALUES (?, ?, ?, ?, ?, ?)`,
      ['Stock Market Hits All-Time High', 'Business', 'The local stock market index crossed a record high today, driven by strong performances in the banking and technology sectors. Analysts predict continued growth through the second half of the year as investor confidence remains strong. International investments have also increased significantly this quarter.', 'stock_market.png', 'Business Desk', 0]);
    await dbRun(`INSERT INTO articles (title, category, content, image, author, is_featured) VALUES (?, ?, ?, ?, ?, ?)`,
      ['Blockbuster Movie Breaks Box Office Records', 'Entertainment', 'The most awaited film of the year has shattered all previous box office records, earning over 500 million in its opening weekend. Critics have praised the film for its stunning visuals and compelling storyline. The movie features an all-star cast and has been described as a cinematic masterpiece.', 'movie.png', 'Entertainment Desk', 0]);
    await dbRun(`INSERT INTO articles (title, category, content, image, author, is_featured) VALUES (?, ?, ?, ?, ?, ?)`,
      ['New Study Reveals Benefits of Daily Exercise', 'Health', 'A new comprehensive study conducted by leading health researchers has found that just 30 minutes of exercise per day can reduce the risk of chronic diseases by up to 35%. The study followed 10,000 participants over 5 years and found significant improvements in mental health, cardiovascular health, and longevity.', 'exercise.png', 'Health Reporter', 0]);
  }
